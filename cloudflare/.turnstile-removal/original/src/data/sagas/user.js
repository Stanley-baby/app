...
function* registerWithPassword({name, email, password, betaAccessPassword, turnstileToken, onSuccess, onFail}) {
	try {
		yield call(Api.post, 'auth/email/signup', {name, email:email||'0', password, betaAccessPassword, turnstileToken});
