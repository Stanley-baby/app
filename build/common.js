...
module.exports = (options={}) => {
	...
	plugins: [
		...
		new webpack.DefinePlugin({
			...
			'process.env.HELP_ORIGIN': JSON.stringify(buildEnvironment.helpOrigin),
			'process.env.REPOSITORY_URL': JSON.stringify(buildEnvironment.repositoryUrl),
			'process.env.WORKERS_BASE_URL': JSON.stringify(buildEnvironment.workersBaseUrl),
			'process.env.PREVIEW_URL': JSON.stringify(buildEnvironment.previewUrl),
